...
### Fixed
- **CI stability**: Isolated smoke test experiment stores to temp directories, added test timeouts, reduced stderr buffer test data size.
...
- Promoted version from 0.3.4 to 1.0.0
